...
class test_exchange extends ccxt.Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'api': {
                    'public': 'https://market-data.dev.gravitymarkets.io/full/v1/',
    ...
    async fetchMarkets () {
        let response = await this.publicPutTicker({}, {instrument: 'BTC_USDT_Perp'});//this.publicGetExchangeInfo ();
